...
public class JSHighlightElement {
	public static void main(String[] args) throws IOException {
		...
		js.executeScript("arguments[0].setAttribute('style', 'border:8px solid red;')", searchButton);
		searchButton.getScreenshotAs(OutputType.FILE);
		File scrFile = searchButton.getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(scrFile, new File(System.getProperty("user.dir") + "\\screenshots\\searchButton.png"));
	}
}
